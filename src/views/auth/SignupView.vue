    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        <div class="rounded-md shadow-sm -space-y-px">
          ...
          <div v-if="emailError" class="text-red-600 text-sm mt-1 text-center">
            {{ emailError }}
          </div>
          <div>
          ...
          <div v-if="passwordError" class="text-red-600 text-sm mt-1 text-center">
            {{ passwordError }}
          </div>
          <div>
          ...
          <div v-if="confirmPasswordError" class="text-red-600 text-sm mt-1 text-center">
